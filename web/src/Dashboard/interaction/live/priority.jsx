...
const LivePriority = (props) => {
    ...
    const getPriorityWiseInteraction = () => {
        axios.post(properties.API_ENDPOINT + properties.INTERACTION_API + '/by-priority', { searchParams: { ...searchParams, category: "LIST", fromDate: moment().format('YYYY-MM-DD'), toDate: moment().format('YYYY-MM-DD HH:mm:ss') } }, {
            headers: {
