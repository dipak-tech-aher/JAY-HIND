...
import createdInteractionColumns from './Columns/createdInteractionColumns';
...
const CreatedInteractionReport = (props) => {
    ...
    const [fieldAccess, setFiledAccess] = useState(false)
    ...
    const getLoginDetails = () => {
        ...
        post(`${properties.REPORTS_API}/created-interactions?limit=${perPage}&page=${currentPage}`, requestBody)
            .then((resp) => {
                if (resp.data) {
                    if (resp.status === 200) {
