...
const SubmitInvoice = (props) => {
    ...
    const { submitInvoiceInputs = {}, previewInvoiceCounts, generateData = [], billingReadOnly, billingGenerated = false } = props.data;
                ...
                <div className="col-12 row pb-2">
                    <div className="col-12 p-0">
                        <fieldset className="scheduler-border2">
                            ...
                            {
                                showSummary &&
                                <div className="row stat-cards col-md-12 p-0" id="infodata4">
                                    <div className="col-12 p-0">
                    ...
                    <div className="col-12 pr-0">
                        ...
                        <div className={`row col-12 pt-3 ${billingReadOnly ? 'd-none' : ''}`}>
                            <div className="text-center col-2 offset-5">
