...
import { InvoiceSearchColumns, InvoicePaymentHiddenColumns, InvoiceDetailPaymentHiddenColumns } from '../../Invoice/InvoiceSearchColumns';
                            ...
                            <div className="row">
                                <div className="col-3">
                                    <div className="form-group">
                                        ...
                                        <input type="text" className="form-control" id="billRefNo" value={accountData[0]?.billRefNo} disabled />
                                    </div>
                                </div>
                                <div className="col-3">
                                    <div className="form-group">
                                ...
                                <div className="col-3">
                                    <div className="form-group">
                                        ...
                                        <NumberFormatBase type="text" className="form-control" id="paymentAmount" value={Number(paymentData.paymentAmount).toFixed(2)}
                                            onChange={(e) => {
                                                handleOnPaymentInputsChange(e)
