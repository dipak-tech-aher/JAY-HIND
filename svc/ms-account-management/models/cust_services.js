module.exports = function (sequelize, DataTypes) {
  const CustServices = sequelize.define('CustServices', {
    ...
    customProperties: {
      type: (sequelize.options.dialect === 'mssql') ? DataTypes.STRING : DataTypes.JSONB,
      get: function () {
        const value = this.getDataValue('customProperties')
        try {
          return value && JSON.parse(value)
        } catch (e) {
          console.log(e)
      ...
      set: function (value) {
        value = typeof value === 'object' ? JSON.stringify(value) : value
        return this.setDataValue('customProperties', value)
      }
    },
  ...
  CustServices.associate = function (models) {
    ...
    models.CustServices.hasMany(models.Orders, {
      sourceKey: 'serviceId',
    ...
    // models.CustServices.belongsTo(models.Orders, {
    //   foreignKey: 'serviceId',
    //   as: 'orderHdrDetails'
    // })
    models.CustServices.belongsTo(models.BusinessEntity, {
